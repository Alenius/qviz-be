...
export const getQuestions = async (request: Request<{}, {}, {}, GetQuestionsEndpointProps>, response: Response) => {
  const { value, error: validationError } = validateJoiSchema<GetQuestionsEndpointProps>(schema, request.query)
